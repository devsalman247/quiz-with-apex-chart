...
document.getElementById("download").addEventListener("click", function downloadPDF(e) {
	...
	setTimeout(() => {
		...
		document.getElementById("c1-q1").style.pageBreakAfter = "always";
		document.getElementById("c2-q0").style.pageBreakAfter = "always";
		document.getElementById("c2-q2").style.pageBreakAfter = "always";
		document.getElementById("c3-q1").style.pageBreakAfter = "always";
		document.getElementById("c4-q0").style.pageBreakAfter = "always";
		document.getElementById("c4-q2").style.pageBreakAfter = "always";
