...
document.getElementById("reset").addEventListener("click", function resetForm() {
	...
	if (document.getElementById("c5-q2")) document.getElementById("c5-q2").style.marginBottom = "";
	if (document.getElementById("c5-q5")) document.getElementById("c5-q5").style.marginBottom = "";
	const ctx = document.getElementById("bar");
	const parentCtx = ctx.parentElement;
